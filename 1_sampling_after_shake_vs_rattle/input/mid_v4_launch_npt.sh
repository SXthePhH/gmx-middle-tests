#!/bin/bash
# ================================================================
# NPT tests for mid_v4 (paper middle scheme + temperature sampling after
# the last position update instead of after the velocity constraint step).
...
# Usage: cd tests/mid_v4 && bash launch_npt.sh
# Results go to results_npt/. Already-finished runs are skipped.
# ================================================================

NPTDIR=/home/shuaix/PKUresearch/gmx/middletest
TESTDIR=/home/shuaix/PKUresearch/gmx/tests/mid_v4
GMX_BIN=/home/shuaix/PKUresearch/gmx/builds/mid_v4/build/bin/gmx_mpi
...
echo "Launching mid_v4 NPT tests..."
echo ""
